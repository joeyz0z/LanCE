...
from Rival10.data.original_rival_dataset import LocalRIVAL10
...
dataset = CSS_Rival_Dataset(split="test", true_batch_size=8,percentage_of_concept_labels_for_training=0.4)
# print(len(dataset))
A,B,C,D = dataset[0]
print(A.shape,B.shape,C.shape,D.shape)
